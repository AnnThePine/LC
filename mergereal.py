...
#merged_data.to_csv("merged_data0.csv", index=False)

# --- Plot merged data ---


freq, odmr = cetri_centri([59, 19.620689655172413, 23],[0,0,1],0.03,5,6.5,-2,4) 
freq1, odmr1 = cetri_centri([59, 19.620689655172413, 23],[1,0,-1],0.01,5,-3.7,-2,4)
